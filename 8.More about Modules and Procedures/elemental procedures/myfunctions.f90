module myfunctions
   ...
   public :: integral_trap, integral_simpson, append, quick_sort, merge2, quick_select, binary_search, brute_force_search, random, linspace, swap
   private :: random_int,random_real
   private :: swap_reals, swap_integers
   !-------------------------------------------------------------------random generic procedure---------------------------------------------------------------------------
   interface random
      module procedure random_int, random_real
   end interface
   !---------------------------------------------------------------end of random generic procedure---------------------------------------------------------------------------
   !--------------------------------------------------------------- swap elemental generic procedure -----------------------------------------------------------------------
   interface swap
      module procedure swap_reals, swap_integers
   end interface
   !-------------------------------------------------------------end of swap elemental generic procedure -----------------------------------------------------------------------
   ...
   !----------------------------------------------------------------------------------------------------------------------------------------------------------------------
   !12. swap_reals(a, b)                                : elemental subroutine, swap a, b, real
   !----------------------------------------------------------------------------------------------------------------------------------------------------------------------
   !13. swap_integers(a, b)                             : elemental subroutine, swap a, b, integers
   !----------------------------------------------------------------------------------------------------------------------------------------------------------------------
   !12 and 13 are generized to swap function (integer and real)
   !----------------------------------------------------------------------------------------------------------------------------------------------------------------------
   !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
   contains
   !*************************************Numerical integral****************************************
...
!***********************************************elemental real swap subroutine***********************************************
...
!***********************************************end of elemental real swap subroutine***********************************************
!***********************************************elemental integer swap subroutine***********************************************
   ...
   !***********************************************end of elemental integer swap subroutine***********************************************
