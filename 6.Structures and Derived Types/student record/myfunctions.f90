module myfunctions
   ...
   private
   public :: integral_trap, integral_simpson, append, quick_sort, merge2, quick_select, binary_search, brute_force_search, random_int, linspace
   ...
   !  high     : upper limit
   !----------------------------------------------------------------------------------------------------------------------------------------------------------------------
   !10. inspace(x, x_start, x_end, x_len)               : subroutine, similar to matlab inspace function, divide a range from x_start to x_end by x_len pieces, double precision
   !  x        : returned array
